        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/interview" className="text-muted-foreground hover:text-foreground transition-smooth">
                Interview
              </Link>
              <Link to="/history" className="text-muted-foreground hover:text-foreground transition-smooth">
                History
              </Link>
              <Link to="/analytics" className="text-muted-foreground hover:text-foreground transition-smooth">
                Analytics
              </Link>
            </nav>
          </div>
